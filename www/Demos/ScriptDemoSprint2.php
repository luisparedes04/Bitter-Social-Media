		...
		if ($rowProd["Option1Desc"] != " ") {
			echo '
				<br clear=all /><br />'
                        ...
                        if($rowProd["Option1a"] != " "){
                            $options = '<li>'. $rowProd["Option1a"] . '</li>';
                        }
                        if($rowProd["Option1b"] != " "){
                            $options .= '<li>'. $rowProd["Option1b"] . '</li>';
                        }
                        if($rowProd["Option1c" != " "]){
                            $options .= '<li>'. $rowProd["Option1c"] . '</li>';
                        }
                        if($rowProd["Option1d"] != " "){
                            $options .= '<li>'. $rowProd["Option1d"] . '</li>';
                        }
			echo '<ul>'. $options . '</ul>';
		...
		if ( $rowProd["Option2Desc"] != "" ) {
		   	echo '
				...
				. $rowProd["Option2Desc"] . ' <br />';
                       ...
                       if($rowProd["Option2a"] != " "){
                            $options = '<li>'. $rowProd["Option2a"] . '</li>';
                        }
                        if($rowProd["Option2b"] != " "){
                            $options .= '<li>'. $rowProd["Option2b"] . '</li>';
                        }
                        if($rowProd["Option2c" != " "]){
                            $options .= '<li>'. $rowProd["Option2c"] . '</li>';
                        }
                        if($rowProd["Option2d"] != " "){
                            $options .= '<li>'. $rowProd["Option2d"] . '</li>';
                        }
			echo'<ul>'. $options . '</ul>';	
		}	
} // End of the while		
